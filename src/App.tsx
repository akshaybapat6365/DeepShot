            ...
            <div className="flex-1 relative overflow-hidden">
              ...
              <div className="relative z-10 flex-1 flex flex-col lg:flex-row items-center justify-center min-h-full p-6 lg:p-12 gap-12">
                ...
                >
                  ...
                  >
                    Precision dosing, layered schedules, and intelligent
                    tracking. Take complete control of your protocol with
                    stunning clarity.
                  </motion.p>
                          ...
                          {trashedInjections.slice(0, 4).map((injection) => (
                            ...
                            >
                              ...
                              <Button
                                ...
                                className="text-white/70 hover:text-white"
                                onClick={() =>
                                  handleRestoreInjection(injection)
                                }
                              >
                                <Undo2 className="size-4 mr-2" />
                                Restore
                ...
                <div ref={calendarRef} className="flex-1 flex flex-col">
                  ...
                  >
                    {monthGrid.map(({ date, isCurrentMonth }, index) => {
                      ...
                      const focusInactive =
                        focusActiveEnabled && !hasActiveLayer;
                      const focusTone =
